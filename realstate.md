...
Listo!
## 127. Property Wishlist Setup Part 6
Hacer visible los datos con ajax
Quitar todo el div de datos de propiedad en resources/views/frontend/dashboard/wishlist.blade.php
```php
<div class="wrapper list">
    ...
    <div class="deals-list-content list-item">
        ...
        {{-- Lo pasamos a resources/views/frontend/frontend_dashboard_no_preload.blade.php --}}
...
```
Y crear la funcion de JS con ajax en resources/views/frontend/frontend_dashboard_no_preload.blade.php
```php
{{-- Start Load Wishlist Data --}}
<script type="text/javascript">
...
Listo!
## 151. Add Custom Pagination Part 2
Modificar resources/views/vendor/pagination/custom.blade.php 
Tomando como referencia el resources/views/vendor/pagination/default.blade.php

Queda asi en resources/views/vendor/pagination/custom.blade.php
```php
...
{{-- Html Estatico Original del Tema --}}
{{-- <ul class="pagination clearfix">
    <li><a href="property-list.html" class="current">1</a></li>
    <li><a href="property-list.html">2</a></li>
    <li><a href="property-list.html">3</a></li>
...
```
Laravel en forma automatica manda llamar esta pagina cuando no encuentar un url valido!
            ...
            <div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="row w-100 mx-0 auth-page">
                    <div class="col-md-8 col-xl-6 mx-auto d-flex flex-column align-items-center">
                        ...
                        <h6 class="text-muted mb-3 text-center">Ups!! La página que estabas buscando no existe.</h6>
                        <a href="{{ route('casa') }}">Regresar a Inicio</a>
                    </div>
                </div>
            ...
            <div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="row w-100 mx-0 auth-page">
                    <div class="col-md-8 col-xl-6 mx-auto d-flex flex-column align-items-center">
                        ...
                        <h4 class="mb-2">El Usuario NO tienes los permisos necesarios</h4>
                        <h6 class="text-muted mb-3 text-center">Ups!! La página que estabas buscando no no puede ser cargada.</h6>
                        <a href="{{ route('casa') }}">Regresar a Inicio</a>
                    </div>
                </div>
...
```
Listo!
## 237. Live Chat Application Part 4 - Pasar la informacion del Agente 
Pasar la informacion del Agente de resources/views/frontend/property/property_details.blade.php a resources/js/components/SendMessage.vue
Para pasar variables se hace asi:
```php
{{-- Desplegar componente de vue --}}
<div id="app">
...
```
Las variables que pasemos solo pueden ser minusculas (receptor_id)
...
```
Listo!
## 238. Live Chat Application Part 5 - Validacion e insertar data a la tala 'chat_messages'
Validacion e insertar data a la tala 'chat_messages'
