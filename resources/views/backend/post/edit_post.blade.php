                        ...
                        @csrf
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="long_descp" class="form-control" id="tinymceExample" rows="10">{!! $post->long_descp !!}</textarea>
                                </div>
                            </div><!-- Col -->
                            ...
                            {{-- Seleccionar Photo Imagen de Post --}}
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="showImage" class="wd-80 rounded-circle" src="{{ asset($post->post_image) }}" alt="postImage">
                            </div>
