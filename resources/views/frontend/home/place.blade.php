        ...
        <div class="sortable-masonry">
            ...
            <div class="items-container row clearfix">
                ...
                <div
                    ...
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset($skip_state_1->state_image) }}" alt="" style="width:370px; height:275px;">
                            </figure>
                            <div class="text">
                                <h4><a href="{{ route('state.details', $skip_state_1->id ) }}">{{ $skip_state_1->state_name }}</a></h4>
                                <p>{{ count($property_1) }} Propiedades</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="place-block-one">
                        <div class="inner-box">
                            ...
                            <div class="text">
                                ...
                                <p>{{ count($property_2) }} Propiedades</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset($skip_state_3->state_image) }}" alt="" style="width:770px; height:275px;">
                            </figure>
                            <div class="text">
                                <h4><a href="{{ route('state.details', $skip_state_3->id ) }}">{{ $skip_state_3->state_name }}</a></h4>
                                <p>{{ count($property_3) }} Propiedades</p>
                            </div>
                        </div>
                    </div>
                </div>
