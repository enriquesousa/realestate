                ...
                <div class="bee-col bee-col-2 bee-col-w5">
                    ...
                    <div class="bee-block bee-block-4 bee-button"><a class="bee-button-content"
                            ...
                            target="_self"><span dir="ltr"
                                style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;">NUESTRA EMPRESA</span></a>
                    </div>
                </div>
        ...
        <div class="bee-row bee-row-5">
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        <p><strong>Hola </strong>{{ $schedule['nombre'] }} <br /><strong>Tu cita ha sido confirmada.</strong></p>

                        <h3>Fecha: {{ $schedule['tour_date'] }}</h3>
                        <h3>Hora : {{ $schedule['tour_time'] }}</h3>
